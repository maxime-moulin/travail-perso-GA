...
variables concernent le problème du sac à dos utilisé comme exemple et
...
croisements et la seconde moitié est remplacée par des individus générés 
aléatoirement.

.. literalinclude:: scripts/GA.py
    :lines: 60-101

Ensuite se trouvent les différentes méthodes, qui s'occupent dans l'ordre : de la 
génération aléatoire de chaque génome, de la génération d'une population aléatoire, 
de calculer la valeur d'évaluation, d'effectuer les croisements à un ou deux points
...
Les méthodes suivantes servent à chronométrer les deux algorithmes de résolution et à calculer 
...
valeurs mimimales et maximales qu'ils doivent prendre ainsi que l'incrément qui définit l'espace 
entre chaque valeur intermédiaire.  
